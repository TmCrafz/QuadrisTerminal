...
tetris: main.o Game.o Drawable.o Stone.o FallenStone.o Point.o PointF.o InputHelper.o
	$(CC) $(CFLAGS) main.o Game.o Drawable.o Stone.o FallenStone.o Point.o PointF.o InputHelper.o -o tetris.o
